...
public class VentaMapper {
    ...
    public DetalleVentaDTO toDetalleDTO(DetalleVentaEntity entity) {
        ...
        DetalleVentaDTO dto = new DetalleVentaDTO(entity.getId(), entity.getIdProducto(), entity.getCantidad(),
                entity.getPrecioUnitario(), entity.getSubtotal());
        dto.setProductoNombre(entity.getProductoNombre());
        dto.setProductoImagenUrl(entity.getProductoImagenUrl());
        return dto;
    }
    ...
    public DetalleVentaEntity detalleToEntity(DetalleVentaDTO dto, VentaEntity venta) {
        ...
        entity.setProductoImagenUrl(dto.getProductoImagenUrl());
        return entity;
    }
